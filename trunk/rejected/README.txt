This is the rejected directory. 

Our transformations in the kettle/lists dir create a log to store those rows from the raw imdb text files that could not be stored in the database. 
